...
# labels = myfile[1:, 0] # alive or dead
...
for num_cluster in [2, 3, 4, 5, 6, 7, 8]:
    ...
    estimators = [('logstic_regression', LogisticRegression(solver='lbfgs', n_jobs=2, multi_class='auto')),
                  ...
                  ('KNN', KNeighborsClassifier(num_cluster)),
